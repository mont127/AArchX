...
| native-mode gate (`-native`) | 72 / 72 |
| native-mode unit suites: API database, image, bridge, ABI, callbacks, thread attach, Objective-C | 308 / 0, 140626 / 0, 877 / 0, 28028 / 0, 131974 / 0, 270 / 0, 123713 / 0 |

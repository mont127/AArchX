...
static const Case cases[] = {
    ...
    { .name = "paddd mm (0f fe)", .bytes = B(0x0f, 0xfe, 0xc1), .nbytes = 3, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_OPSIZE | CHK_O0_KIND | CHK_O0_REG | CHK_O0_SIZE | CHK_O1_KIND | CHK_O1_REG,
      .ret = OCERZ_OK, .op = OCERZ_OP_PADDD, .opsize = 8, .o0_kind = OCERZ_OPK_MMX, .o0_reg = 0, .o0_size = 8,
      .o1_kind = OCERZ_OPK_MMX, .o1_reg = 1 },
    { .name = "paddb mm rex.rb ignored (45 0f fc d5)", .bytes = B(0x45, 0x0f, 0xfc, 0xd5), .nbytes = 4, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_KIND | CHK_O0_REG | CHK_O1_KIND | CHK_O1_REG, .ret = OCERZ_OK,
      .op = OCERZ_OP_PADDB, .o0_kind = OCERZ_OPK_MMX, .o0_reg = 2, .o1_kind = OCERZ_OPK_MMX, .o1_reg = 5 },
    { .name = "movq mm, m64 (0f 6f)", .bytes = B(0x0f, 0x6f, 0x57, 0x08), .nbytes = 4, .avail = 8,
      .chk = CHK_RET | CHK_LEN | CHK_OP | CHK_O0_KIND | CHK_O0_REG | CHK_O1_KIND | CHK_O1_SIZE | CHK_O1_DISP,
      .ret = OCERZ_OK, .len = 4, .op = OCERZ_OP_MOVQX, .o0_kind = OCERZ_OPK_MMX, .o0_reg = 2,
      .o1_kind = OCERZ_OPK_MEM, .o1_size = 8, .o1_disp = 8 },
    { .name = "movq m64, mm (0f 7f)", .bytes = B(0x0f, 0x7f, 0x57, 0x10), .nbytes = 4, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_KIND | CHK_O0_SIZE | CHK_O0_DISP | CHK_O1_KIND | CHK_O1_REG, .ret = OCERZ_OK,
      .op = OCERZ_OP_MOVQX, .o0_kind = OCERZ_OPK_MEM, .o0_size = 8, .o0_disp = 16, .o1_kind = OCERZ_OPK_MMX, .o1_reg = 2 },
    { .name = "movd mm, eax (0f 6e)", .bytes = B(0x0f, 0x6e, 0xc0), .nbytes = 3, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_KIND | CHK_O1_KIND | CHK_O1_SIZE, .ret = OCERZ_OK,
      .op = OCERZ_OP_MOVD, .o0_kind = OCERZ_OPK_MMX, .o1_kind = OCERZ_OPK_REG, .o1_size = 4 },
    { .name = "movq rcx, mm1 (48 0f 7e)", .bytes = B(0x48, 0x0f, 0x7e, 0xc9), .nbytes = 4, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_KIND | CHK_O0_REG | CHK_O0_SIZE | CHK_O1_KIND | CHK_O1_REG, .ret = OCERZ_OK,
      .op = OCERZ_OP_MOVQX, .o0_kind = OCERZ_OPK_REG, .o0_reg = 1, .o0_size = 8, .o1_kind = OCERZ_OPK_MMX, .o1_reg = 1 },
    { .name = "pshufw (0f 70)", .bytes = B(0x0f, 0x70, 0xd5, 0x1b), .nbytes = 4, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_NOPS | CHK_O0_KIND | CHK_O1_KIND | CHK_O2_IMM, .ret = OCERZ_OK,
      .op = OCERZ_OP_PSHUFLW, .nops = 3, .o0_kind = OCERZ_OPK_MMX, .o1_kind = OCERZ_OPK_MMX, .o2_imm = 0x1b },
    { .name = "psrlw mm imm (0f 71 /2)", .bytes = B(0x0f, 0x71, 0xd2, 0x03), .nbytes = 4, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_KIND | CHK_O0_REG | CHK_O1_IMM, .ret = OCERZ_OK,
      .op = OCERZ_OP_PSRLW, .o0_kind = OCERZ_OPK_MMX, .o0_reg = 2, .o1_imm = 3 },
    { .name = "pshufb mm (0f 38 00)", .bytes = B(0x0f, 0x38, 0x00, 0xd5), .nbytes = 4, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_KIND | CHK_O1_KIND, .ret = OCERZ_OK,
      .op = OCERZ_OP_PSHUFB, .o0_kind = OCERZ_OPK_MMX, .o1_kind = OCERZ_OPK_MMX },
    { .name = "palignr mm (0f 3a 0f)", .bytes = B(0x0f, 0x3a, 0x0f, 0xd5, 0x03), .nbytes = 5, .avail = 8,
      .chk = CHK_RET | CHK_LEN | CHK_OP | CHK_O0_KIND | CHK_O2_IMM, .ret = OCERZ_OK,
      .len = 5, .op = OCERZ_OP_PALIGNR, .o0_kind = OCERZ_OPK_MMX, .o2_imm = 3 },
    { .name = "pextrw eax, mm2 (0f c5)", .bytes = B(0x0f, 0xc5, 0xc2, 0x02), .nbytes = 4, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_KIND | CHK_O1_KIND | CHK_O1_REG | CHK_O2_IMM, .ret = OCERZ_OK,
      .op = OCERZ_OP_PEXTRW, .o0_kind = OCERZ_OPK_REG, .o1_kind = OCERZ_OPK_MMX, .o1_reg = 2, .o2_imm = 2 },
    { .name = "movq2dq (f3 0f d6)", .bytes = B(0xf3, 0x0f, 0xd6, 0xdd), .nbytes = 4, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_KIND | CHK_O0_REG | CHK_O1_KIND | CHK_O1_REG, .ret = OCERZ_OK,
      .op = OCERZ_OP_MOVQX, .o0_kind = OCERZ_OPK_XMM, .o0_reg = 3, .o1_kind = OCERZ_OPK_MMX, .o1_reg = 5 },
    { .name = "cvtpi2ps (0f 2a)", .bytes = B(0x0f, 0x2a, 0xdd), .nbytes = 3, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_KIND | CHK_O1_KIND, .ret = OCERZ_OK,
      .op = OCERZ_OP_CVTPI2PS, .o0_kind = OCERZ_OPK_XMM, .o1_kind = OCERZ_OPK_MMX },
    { .name = "cvtpd2pi m128 (66 0f 2d)", .bytes = B(0x66, 0x0f, 0x2d, 0x57, 0x08), .nbytes = 5, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_KIND | CHK_O1_KIND | CHK_O1_SIZE, .ret = OCERZ_OK,
      .op = OCERZ_OP_CVTPD2PI, .o0_kind = OCERZ_OPK_MMX, .o1_kind = OCERZ_OPK_MEM, .o1_size = 16 },
    ...
    { .name = "vpbroadcastb ymm1,xmm0", .bytes = B(0xc4, 0xe2, 0x7d, 0x78, 0xc8), .nbytes = 5, .avail = 8,
      .chk = CHK_RET | CHK_LEN | CHK_OP | CHK_O0_KIND | CHK_O0_REG | CHK_O1_KIND | CHK_O1_REG,
      .ret = OCERZ_OK, .len = 5, .op = OCERZ_OP_VPBROADCASTB, .o0_kind = OCERZ_OPK_XMM, .o0_reg = 1,
      .o1_kind = OCERZ_OPK_XMM, .o1_reg = 0 },
    { .name = "vpbroadcastq ymm2,[rdi]", .bytes = B(0xc4, 0xe2, 0x7d, 0x59, 0x17), .nbytes = 5, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_REG | CHK_O1_KIND | CHK_O1_SIZE,
      .ret = OCERZ_OK, .op = OCERZ_OP_VPBROADCASTQ, .o0_reg = 2, .o1_kind = OCERZ_OPK_MEM, .o1_size = 8 },
    { .name = "vpermq ymm0,ymm1,0x1b", .bytes = B(0xc4, 0xe3, 0xfd, 0x00, 0xc1, 0x1b), .nbytes = 6, .avail = 8,
      .chk = CHK_RET | CHK_LEN | CHK_OP | CHK_O0_REG | CHK_O1_REG | CHK_O2_KIND | CHK_O2_IMM,
      .ret = OCERZ_OK, .len = 6, .op = OCERZ_OP_VPERMQ, .o0_reg = 0, .o1_reg = 1,
      .o2_kind = OCERZ_OPK_IMM, .o2_imm = 0x1b },
    { .name = "EUNDEF vpermq VEX.L=0", .bytes = B(0xc4, 0xe3, 0xf9, 0x00, 0xc1, 0x1b), .nbytes = 6, .avail = 8,
      .chk = CHK_RET, .ret = OCERZ_EUNDEF },
    { .name = "vpblendd ymm0,ymm1,ymm2,0x5a", .bytes = B(0xc4, 0xe3, 0x75, 0x02, 0xc2, 0x5a), .nbytes = 6, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_REG | CHK_O1_REG | CHK_O2_IMM,
      .ret = OCERZ_OK, .op = OCERZ_OP_VPBLENDD, .o0_reg = 0, .o1_reg = 2, .o2_imm = 0x5a },
    { .name = "vinserti128 ymm0,ymm1,xmm2,1", .bytes = B(0xc4, 0xe3, 0x75, 0x38, 0xc2, 0x01), .nbytes = 6, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_REG | CHK_O1_REG | CHK_O2_IMM,
      .ret = OCERZ_OK, .op = OCERZ_OP_VINSERTI128, .o0_reg = 0, .o1_reg = 2, .o2_imm = 1 },
    { .name = "vextracti128 xmm1,ymm0,1", .bytes = B(0xc4, 0xe3, 0x7d, 0x39, 0xc1, 0x01), .nbytes = 6, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_REG | CHK_O1_REG | CHK_O2_IMM,
      .ret = OCERZ_OK, .op = OCERZ_OP_VEXTRACTI128, .o0_reg = 1, .o1_reg = 0, .o2_imm = 1 },
    { .name = "vperm2i128 ymm0,ymm1,ymm2,0x31", .bytes = B(0xc4, 0xe3, 0x75, 0x46, 0xc2, 0x31), .nbytes = 6, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O2_IMM, .ret = OCERZ_OK, .op = OCERZ_OP_VPERM2I128, .o2_imm = 0x31 },
    { .name = "vpsllvq ymm0,ymm1,ymm2", .bytes = B(0xc4, 0xe2, 0xf5, 0x47, 0xc2), .nbytes = 5, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_REG | CHK_O1_REG,
      .ret = OCERZ_OK, .op = OCERZ_OP_VPSLLVQ, .o0_reg = 0, .o1_reg = 2 },
    { .name = "vpmaskmovd [rdi],ymm1,ymm0", .bytes = B(0xc4, 0xe2, 0x75, 0x8e, 0x07), .nbytes = 5, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_KIND | CHK_O0_BASE | CHK_O1_KIND | CHK_O1_REG,
      .ret = OCERZ_OK, .op = OCERZ_OP_VPMASKMOVD, .o0_kind = OCERZ_OPK_MEM, .o0_base = OCERZ_RDI,
      .o1_kind = OCERZ_OPK_XMM, .o1_reg = 0 },
    { .name = "EUNDEF vpmaskmovd load from a register", .bytes = B(0xc4, 0xe2, 0x75, 0x8c, 0xc0), .nbytes = 5, .avail = 8,
      .chk = CHK_RET, .ret = OCERZ_EUNDEF },
    { .name = "vpgatherdd ymm0,[rdi+ymm4*4],ymm1", .bytes = B(0xc4, 0xe2, 0x75, 0x90, 0x04, 0xa7), .nbytes = 6, .avail = 8,
      .chk = CHK_RET | CHK_LEN | CHK_OP | CHK_O0_REG | CHK_O1_KIND | CHK_O1_INDEX,
      .ret = OCERZ_OK, .len = 6, .op = OCERZ_OP_VPGATHERDD, .o0_reg = 0, .o1_kind = OCERZ_OPK_MEM, .o1_index = 4 },
    { .name = "EUNDEF vpgatherdd without SIB", .bytes = B(0xc4, 0xe2, 0x75, 0x90, 0x07), .nbytes = 5, .avail = 8,
      .chk = CHK_RET, .ret = OCERZ_EUNDEF },
    { .name = "vfmadd231ps ymm0,ymm1,ymm2", .bytes = B(0xc4, 0xe2, 0x75, 0xb8, 0xc2), .nbytes = 5, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_REG | CHK_O1_REG,
      .ret = OCERZ_OK, .op = OCERZ_OP_VFMA_FIRST + 44, .o0_reg = 0, .o1_reg = 2 },
    { .name = "vfmadd132sd xmm0,xmm1,[rdi]", .bytes = B(0xc4, 0xe2, 0xf1, 0x99, 0x07), .nbytes = 5, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O1_KIND | CHK_O1_SIZE,
      .ret = OCERZ_OK, .op = OCERZ_OP_VFMA_FIRST + 7, .o1_kind = OCERZ_OPK_MEM, .o1_size = 8 },
    { .name = "andn eax,ebx,ecx", .bytes = B(0xc4, 0xe2, 0x60, 0xf2, 0xc1), .nbytes = 5, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_NOPS | CHK_OPSIZE | CHK_O0_REG | CHK_O1_REG | CHK_O2_REG,
      .ret = OCERZ_OK, .op = OCERZ_OP_ANDN, .nops = 3, .opsize = 4, .o0_reg = OCERZ_RAX, .o1_reg = OCERZ_RBX,
      .o2_reg = OCERZ_RCX },
    { .name = "EUNDEF andn VEX.L=1", .bytes = B(0xc4, 0xe2, 0x7c, 0xf2, 0xc1), .nbytes = 5, .avail = 8,
      .chk = CHK_RET, .ret = OCERZ_EUNDEF },
    { .name = "blsr eax,ecx", .bytes = B(0xc4, 0xe2, 0x78, 0xf3, 0xc9), .nbytes = 5, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_NOPS | CHK_O0_REG | CHK_O1_REG,
      .ret = OCERZ_OK, .op = OCERZ_OP_BLSR, .nops = 2, .o0_reg = OCERZ_RAX, .o1_reg = OCERZ_RCX },
    { .name = "shlx rax,rcx,rdx", .bytes = B(0xc4, 0xe2, 0xe9, 0xf7, 0xc1), .nbytes = 5, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_OPSIZE | CHK_O0_REG | CHK_O1_REG | CHK_O2_REG,
      .ret = OCERZ_OK, .op = OCERZ_OP_SHLX, .opsize = 8, .o0_reg = OCERZ_RAX, .o1_reg = OCERZ_RCX,
      .o2_reg = OCERZ_RDX },
    { .name = "rorx eax,ecx,5", .bytes = B(0xc4, 0xe3, 0x7b, 0xf0, 0xc1, 0x05), .nbytes = 6, .avail = 8,
      .chk = CHK_RET | CHK_LEN | CHK_OP | CHK_O0_REG | CHK_O1_REG | CHK_O2_KIND | CHK_O2_IMM,
      .ret = OCERZ_OK, .len = 6, .op = OCERZ_OP_RORX, .o0_reg = OCERZ_RAX, .o1_reg = OCERZ_RCX,
      .o2_kind = OCERZ_OPK_IMM, .o2_imm = 5 },
    { .name = "mulx r8,rax,[rdi]", .bytes = B(0xc4, 0x62, 0xfb, 0xf6, 0x07), .nbytes = 5, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_REG | CHK_O1_REG | CHK_O2_KIND,
      .ret = OCERZ_OK, .op = OCERZ_OP_MULX, .o0_reg = OCERZ_R8, .o1_reg = OCERZ_RAX, .o2_kind = OCERZ_OPK_MEM },
    { .name = "pdep rax,rbx,rcx", .bytes = B(0xc4, 0xe2, 0xe3, 0xf5, 0xc1), .nbytes = 5, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_REG | CHK_O1_REG | CHK_O2_REG,
      .ret = OCERZ_OK, .op = OCERZ_OP_PDEP, .o0_reg = OCERZ_RAX, .o1_reg = OCERZ_RBX, .o2_reg = OCERZ_RCX },
    { .name = "bzhi eax,ecx,edx", .bytes = B(0xc4, 0xe2, 0x68, 0xf5, 0xc1), .nbytes = 5, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_O0_REG | CHK_O1_REG | CHK_O2_REG,
      .ret = OCERZ_OK, .op = OCERZ_OP_BZHI, .o0_reg = OCERZ_RAX, .o1_reg = OCERZ_RCX, .o2_reg = OCERZ_RDX },
    { .name = "movbe eax,[rdi]", .bytes = B(0x0f, 0x38, 0xf0, 0x07), .nbytes = 4, .avail = 8,
      .chk = CHK_RET | CHK_LEN | CHK_OP | CHK_OPSIZE | CHK_O0_KIND | CHK_O0_REG | CHK_O1_KIND,
      .ret = OCERZ_OK, .len = 4, .op = OCERZ_OP_MOVBE, .opsize = 4, .o0_kind = OCERZ_OPK_REG, .o0_reg = OCERZ_RAX,
      .o1_kind = OCERZ_OPK_MEM },
    { .name = "movbe [rdi],ax", .bytes = B(0x66, 0x0f, 0x38, 0xf1, 0x07), .nbytes = 5, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_OPSIZE | CHK_O0_KIND | CHK_O1_REG,
      .ret = OCERZ_OK, .op = OCERZ_OP_MOVBE, .opsize = 2, .o0_kind = OCERZ_OPK_MEM, .o1_reg = OCERZ_RAX },
    { .name = "EUNDEF movbe with a register operand", .bytes = B(0x0f, 0x38, 0xf0, 0xc0), .nbytes = 4, .avail = 8,
      .chk = CHK_RET, .ret = OCERZ_EUNDEF },
    { .name = "xsave [rdi]", .bytes = B(0x0f, 0xae, 0x27), .nbytes = 3, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_NOPS | CHK_O0_KIND | CHK_O0_BASE,
      .ret = OCERZ_OK, .op = OCERZ_OP_XSAVE, .nops = 1, .o0_kind = OCERZ_OPK_MEM, .o0_base = OCERZ_RDI },
    { .name = "xrstor [rdi]", .bytes = B(0x0f, 0xae, 0x2f), .nbytes = 3, .avail = 8,
      .chk = CHK_RET | CHK_OP, .ret = OCERZ_OK, .op = OCERZ_OP_XRSTOR },
    { .name = "EUNDEF xsaveopt (0f ae /6)", .bytes = B(0x0f, 0xae, 0x37), .nbytes = 3, .avail = 8,
      .chk = CHK_RET, .ret = OCERZ_EUNDEF },
    { .name = "rdrand eax", .bytes = B(0x0f, 0xc7, 0xf0), .nbytes = 3, .avail = 8,
      .chk = CHK_RET | CHK_OP | CHK_OPSIZE | CHK_O0_REG,
      .ret = OCERZ_OK, .op = OCERZ_OP_RDRAND, .opsize = 4, .o0_reg = OCERZ_RAX },
    { .name = "EUNDEF cli (fa)", .bytes = B(0xfa), .nbytes = 1, .avail = 8,
      .chk = CHK_RET, .ret = OCERZ_EUNDEF },
    { .name = "EUNDEF in al (e4)", .bytes = B(0xe4, 0x00), .nbytes = 2, .avail = 8,
      .chk = CHK_RET, .ret = OCERZ_EUNDEF },
    { .name = "EUNDEF punpcklqdq no66 (0f 6c)", .bytes = B(0x0f, 0x6c, 0xc1), .nbytes = 3, .avail = 8,
      .chk = CHK_RET, .ret = OCERZ_EUNDEF },
    { .name = "EUNDEF psrldq mmx (0f 73 /3)", .bytes = B(0x0f, 0x73, 0xd8, 0x04), .nbytes = 4, .avail = 8,
      .chk = CHK_RET, .ret = OCERZ_EUNDEF },
    { .name = "EUNDEF movntq reg (0f e7 c1)", .bytes = B(0x0f, 0xe7, 0xc1), .nbytes = 3, .avail = 8,
      .chk = CHK_RET, .ret = OCERZ_EUNDEF },
    { .name = "EUNDEF pblendvb no66 (0f 38 10)", .bytes = B(0x0f, 0x38, 0x10, 0xc1), .nbytes = 4, .avail = 8,
      .chk = CHK_RET, .ret = OCERZ_EUNDEF },
...
static int run_case(const Case *c)
{
    ...
    if ((c->chk & CHK_O1_INDEX) && o1->index != c->o1_index)
        fails += field_fail(c->name, "o1.index", o1->index, c->o1_index);

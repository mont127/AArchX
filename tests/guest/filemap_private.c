 ...
 *
 * One case is a fixed mapping at a 4 KB-aligned address with a matching 4 KB
 * offset, where the head page is read in and the interior is mapped.
 */
#include "gsys.h"

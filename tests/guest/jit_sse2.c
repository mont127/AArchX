...
int main(void){
    x128 a = { 0x3ff0000000000000ULL, 0x4000000000000000ULL };
    x128 b = { 0x4008000000000000ULL, 0xc010000000000000ULL };
    x128 f = { 0x3f80000040000000ULL, 0x4040000040800000ULL };
    x128 r, m; g_u64 g;
    ...
    m.lo = 0x8000000000000000ULL; m.hi = 0;

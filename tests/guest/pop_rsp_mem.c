 ...
 *
 * Two shapes pin the rule: `pop [rsp]`, whose destination is old+8 (the slot
 * right above the popped one), and the V8 shape `pop [rsp+0x98]` followed by
 * `add rsp,0x98`, which must leave the popped value at the new top of stack.
 */
#include "gsys.h"

 ...
 *
 * Also covers the cmpss/cmpsd predicates 0..7 with NaN and ordered operands
 * (mask results), and the invalid operations that produce a default NaN from
 * non-NaN inputs: inf-inf, 0*inf, 0/0 and sqrt(-1), whose sign is checked.
 */
#include "gsys.h"
...
static const g_u32 fv[] = {
    0x3fc00000u, 0x7f800000u, 0xff800000u, 0x00000000u,
    0x7f800001u, 0xff800002u, 0x7fc00001u,
    0xffc00003u, 0x7fc00000u, 0xffc00000u, 0x80000000u };

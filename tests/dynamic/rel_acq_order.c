 ...
 * write float past the release, or a read float above the acquire, the reader
 * would observe a stale value.  This pins the memory-ordering correctness a
 * translator is tempted to trade away for speed - 0 errors is the only pass.
 */
#include <pthread.h>
#include <stdatomic.h>
#include <stdio.h>

...
void a64_stp_q_off(A64Buf *b, int qt, int qt2, int rn, int imm);
void a64_ldp_q_off(A64Buf *b, int qt, int qt2, int rn, int imm);
...
void a64_umov_gpr(A64Buf *b, int esize, int rd, int vn, int idx);
...
void a64_v_sshr_16b(A64Buf *b, int vd, int vn, int sh);
void a64_v_addp_16b(A64Buf *b, int vd, int vn, int vm);
void a64_umov_w_h(A64Buf *b, int rd, int vn, int idx);
void a64_umov_w_b(A64Buf *b, int rd, int vn, int idx);
...
void a64_fmaxp_d(A64Buf *b, int dd, int vn);
void a64_v_fcmgt(A64Buf *b, int dbl, int vd, int vn, int vm);
void a64_v_fcmge(A64Buf *b, int dbl, int vd, int vn, int vm);
void a64_fcmeq_s(A64Buf *b, int dbl, int vd, int vn, int vm);
void a64_fcmgt_s(A64Buf *b, int dbl, int vd, int vn, int vm);
...
void a64_v_umax(A64Buf *b, int esz, int vd, int vn, int vm);
void a64_v_smin(A64Buf *b, int esz, int vd, int vn, int vm);
void a64_v_smax(A64Buf *b, int esz, int vd, int vn, int vm);
void a64_v_mul(A64Buf *b, int esz, int vd, int vn, int vm);
void a64_v_uqadd(A64Buf *b, int esz, int vd, int vn, int vm);
void a64_v_uqsub(A64Buf *b, int esz, int vd, int vn, int vm);
void a64_v_sqadd(A64Buf *b, int esz, int vd, int vn, int vm);
void a64_v_sqsub(A64Buf *b, int esz, int vd, int vn, int vm);
void a64_v_urhadd(A64Buf *b, int esz, int vd, int vn, int vm);
void a64_v_dup_b(A64Buf *b, int vd, int vn, int idx);
void a64_v_dup_h(A64Buf *b, int vd, int vn, int idx);
void a64_v_dup_gpr(A64Buf *b, int esize, int vd, int rn);
